...
class DeliveryController extends Controller
{
    ...
    {
        $orders = Order::whereIn('condition', ['shipped', 'out for delivery'])->get();

        // Iterate through each order and fetch user's name
        foreach ($orders as $order) {
            $user = User::find($order->user_id); // Assuming there's a 'users' table
